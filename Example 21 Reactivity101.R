# Reactive sources
# reactive endpoint
# Reactive conductor (to avoid repeatation), lazy evalation and cached
...
server <- function(input, output, session) {
    ...
    rval_bmi <- reactive({
        input$weight/(input$height^2)  #This is reactive conductor which is used in multiple places
    })
